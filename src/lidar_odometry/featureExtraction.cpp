...
public:
    ...
    FeatureExtraction()
    {
        subLaserCloudInfo = nh.subscribe<emv_lio::cloud_info>(PROJECT_NAME + "/lidar/deskew/cloud_info", 5, &FeatureExtraction::laserCloudInfoHandler, this, ros::TransportHints().tcpNoDelay());

        pubLaserCloudInfo = nh.advertise<emv_lio::cloud_info> (PROJECT_NAME + "/lidar/feature/cloud_info", 5);
    ...
    void laserCloudInfoHandler(const emv_lio::cloud_infoConstPtr& msgIn)
    {
