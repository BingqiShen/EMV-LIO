...
public:
    ...
    mapOptimization()
    {
        ...
        subLaserCloudInfo     = nh.subscribe<emv_lio::cloud_info>     (PROJECT_NAME + "/lidar/feature/cloud_info", 5, &mapOptimization::laserCloudInfoHandler, this, ros::TransportHints().tcpNoDelay());
